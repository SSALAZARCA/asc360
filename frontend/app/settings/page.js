...
// Orden columnas: superadmin | administrativo | jefe_taller | technician | parts_dealer | proveedor | client
// is_imports_editor = superadmin + administrativo + proveedor
const PERM_GROUPS = [
  {
    ...
    rows: [
      ...
      { label: 'Registro de Motocicletas',           perms: [true,  true,  false, false, true,  false, false] },
      ...
      { label: 'Catálogo de Partes',                perms: [true,  true,  false, false, false, false, false] },
      { label: 'Configuración del Sistema',         perms: [true,  false, false, false, false, false, false] },
    ],
  },
  {
    label: 'Pedidos — Tab general',
    rows: [
      { label: 'Ver listado de pedidos',            perms: [true,  true,  false, false, false, true,  false] },
      { label: 'Ver detalle / timeline de pedido',  perms: [true,  true,  false, false, false, true,  false] },
      ...
      { label: 'Exportar pedidos a Excel',          perms: [true,  true,  false, false, false, true,  false] },
      ...
      { label: 'Eliminar doc. adjunto (desde detalle del pedido)',perms: [true,  false, false, false, false, false, false] },
    ],
  },
  {
    label: 'Motocicletas — Tab VINs',
    rows: [
      { label: 'Ver unidades / VINs',               perms: [true,  true,  false, false, false, true,  false] },
      { label: 'Editar unidad (VIN, motor, etc.)',   perms: [true,  true,  false, false, false, true,  false] },
      { label: 'Cargar DIM',                        perms: [true,  true,  false, false, false, false, false] },
      { label: 'Descargar DIM (PDF)',                perms: [true,  true,  false, false, false, false, false] },
      { label: 'Descargar certificado empadronam.',  perms: [true,  true,  false, false, false, false, false] },
      { label: 'Anular empadronamiento',             perms: [true,  true,  false, false, false, false, false] },
      { label: 'Marcar envío físico empadronam.',    perms: [true,  true,  false, false, false, false, false] },
      { label: 'Exportar unidades a Excel',          perms: [true,  true,  false, false, false, true,  false] },
    ],
  },
  {
    label: 'Repuestos — Tab SP',
    rows: [
      { label: 'Ver lotes y sus ítems',              perms: [true,  true,  false, false, false, true,  false] },
      { label: 'Cargar detalle de orden (PI Detail)',perms: [true,  true,  false, false, false, true,  false] },
      { label: 'Cargar Packing List (reconciliación)',perms:[true,  true,  false, false, false, true,  false] },
      { label: 'Editar ítems inline (precio, qty…)', perms: [true,  true,  false, false, false, true,  false] },
      { label: 'Cambiar estado de ítem',             perms: [true,  true,  false, false, false, true,  false] },
      { label: 'Cargar inventario físico (Excel)',    perms: [true,  true,  false, false, false, true,  false] },
      { label: 'Cancelar unidades pendientes',       perms: [true,  true,  false, false, false, false, false] },
      { label: 'Rollback / Revertir lote SP',        perms: [true,  false, false, false, false, false, false] },
      { label: 'Exportar repuestos a Excel',         perms: [true,  true,  false, false, false, true,  false] },
    ],
  },
  {
    label: 'Backorders',
    rows: [
      { label: 'Ver backorders activos / resueltos', perms: [true,  true,  false, false, false, true,  false] },
      { label: 'Editar PI esperado (inline)',         perms: [true,  true,  false, false, false, true,  false] },
      { label: 'Asignar PI masivamente',              perms: [true,  true,  false, false, false, true,  false] },
      { label: 'Marcar backorder como resuelto',      perms: [true,  true,  false, false, false, true,  false] },
      { label: 'Carga masiva de resolución (Excel)',  perms: [true,  true,  false, false, false, true,  false] },
      { label: 'Revertir carga masiva',               perms: [true,  false, false, false, false, false, false] },
      { label: 'Exportar backorders a Excel',         perms: [true,  false, false, false, false, false, false] },
    ],
  },
  {
    label: 'Órdenes de Servicio',
    rows: [
      { label: 'Ver órdenes',                        perms: [true,  true,  'p',   'p',   'p',   false, 'p' ] },
      ...
      { label: 'Descargar acta recepción (PDF)',      perms: [true,  true,  'p',   'p',   'p',   false, 'p' ] },
      { label: 'Descargar orden de salida (PDF)',     perms: [true,  true,  'p',   'p',   'p',   false, 'p' ] },
      { label: 'Exportar órdenes a Excel',            perms: [true,  true,  false, false, false, false, false] },
    ],
  },
  {
    ...
    rows: [
      ...
      { label: 'Editar usuario',                     perms: [true,  false, false, false, false, false, false] },
      { label: 'Eliminar usuario',                   perms: [true,  false, false, false, false, false, false] },
      { label: 'Aprobar / Rechazar acceso',          perms: [true,  false, 'p',   false, false, false, false] },
      { label: 'Cambiar contraseña de usuario',      perms: [true,  false, false, false, false, false, false] },
    ],
  },
  {
    ...
    rows: [
      ...
      { label: 'Cargar PDFs de secciones',           perms: [true,  false, false, false, false, false, false] },
