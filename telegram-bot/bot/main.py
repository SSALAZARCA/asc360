    ...
    master_conv = ConversationHandler(
        ...
        states={
            ...
            CONFIRMING_RETURNING_CLIENT: [
                cancel_text,
                MessageHandler(filters.VOICE, cancel_voice_handler),
                CallbackQueryHandler(handle_returning_client_confirmation, pattern="^client_data_")
            ],
            SELECTING_CLIENT_FIELD: [
                cancel_text,
                MessageHandler(filters.VOICE, cancel_voice_handler),
                CallbackQueryHandler(handle_client_field_selection, pattern="^field_")
            ],
            EDITING_CLIENT_FIELD: [
                btn_escape,
                MessageHandler(filters.TEXT | filters.VOICE, handle_client_field_value)
            ],
            ASKING_PHONE: [
                btn_escape,
            ...
            ASKING_GENERAL_OBSERVATIONS: [
                btn_escape,
                MessageHandler(filters.TEXT | filters.VOICE, handle_general_observations),
                CallbackQueryHandler(handle_general_observations_skip, pattern="^obs_none$"),
            ],
            ASKING_MOTIVE: [
                btn_escape,
            ...
            ASKING_INTAKE_QUESTION: [
                btn_escape,
                MessageHandler(filters.TEXT | filters.VOICE, handle_intake_question),
            ],
            CORRECTING_MOTIVE: [
                btn_escape,
